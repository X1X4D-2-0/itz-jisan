            ...
            if (b.nodeType === 1 && d.hasData(a)) {
                ...
                if (e = e[c]) {
                    ...
                    if (g) {
                        ...
                        for (var h in g)
                            for (var i = 0, j = g[h].length; i < j; i++) d.event.add(b, h, g[h][i], g[h][i].data)
                    }
                }
            }
        }
        ...
        var c = a.document,
            d = function() {
                ...
                d.fn = d.prototype = {
                    ...
                    return G.call(b, a)
                }), i.test("A ") && (j = /^[\s\xA0]+/, k = /[\s\xA0]+$/), g = d(c), c.addEventListener ? A = function() {
        ...
        d.extend({
                    ...
                    removeData: function(b, c, e) {
                            if (d.acceptData(b)) {
                                ...
                                var k = h[i][f];
                                d.support.deleteExpando || h != a ? delete h[i] : h[i] = null, k ? (h[i] = {}, h[i][f] = k) : g && (d.support.deleteExpando ? delete b[d.expando